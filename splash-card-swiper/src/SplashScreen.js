...
const AnimatedText = ({ texts }) => {
  ...
  return (
    <h1 className={`text-4xl md:text-6xl font-bold leading-tight transition-all duration-700 transform ${fade ? 'opacity-0 translate-y-5' : 'opacity-100 translate-y-0'}`}>
...
const SplashScreen = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-b from-blue-200 to-white">
      ...
      <div className="flex flex-col items-center justify-center h-full px-6 py-10 text-center space-y-12 animate__animated animate__fadeIn animate__slow">
        {/* Header with Animated Text */}
        <div className="space-y-4">
          <AnimatedText texts={dynamicTexts} />
          <p className="text-lg md:text-xl text-gray-600 mt-4 animate__animated animate__fadeInUp">
            "Your gateway to mastering skills and unlocking job opportunities"
          </p>
        </div>

        {/* Enhanced Lottie Animation */}
        <div className="w-[250px] h-[250px] md:w-[300px] md:h-[300px] mx-auto transform transition-transform duration-700 hover:scale-110 animate__animated animate__zoomIn animate__slow">
          <dotlottie-player
        ...
        <button
          ...
          className="bg-blue-600 text-white px-8 py-4 rounded-lg hover:bg-blue-700 transition-all duration-300 min-w-[700px]  text-lg" // Increased padding and added min width
