      ...
      <div className="bg-[#FAFAFA] py-10px-4 lg:px-16">
         <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="lg:w-1/2 w-full">
                ...
                <input type="date" placeholder="Ex: 2024-12-31" 
            ...
            <div className="lg:w-1/2 w-full">
                ...
                <input type="url" placeholder="Paste your company logo url: https://company.com/img" 
            ...
            rows={6}
            defaultValue={"Software Engineer required with at least 5 years of experience and knowledge in Android Development"}
